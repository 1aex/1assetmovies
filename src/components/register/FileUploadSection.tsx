  ...
  const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const { data, error } = await supabase.storage
        .from("ipvault") // Replace with your bucket name
      ...
      setUploadedFileName(publicUrlData.publicUrl);

      console.log("File uploaded successfully:", publicUrlData.publicUrl);

      toast({
        title: "File uploaded successfully",
        description: "Your file has been uploaded and is ready for registration.",
      });
    } catch (error) {
      toast({
        title: "Upload failed",
